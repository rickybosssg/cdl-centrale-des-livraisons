...
import { Package, Home, Clock, Users, BarChart3, Truck, Plus, LogOut, TrendingUp, Database, Store, Sparkles, Megaphone } from "lucide-react";
...
const NAV_ITEMS = {
  ...
  dispatcher: [
    ...
    { path: "/gerer-publicites", icon: Megaphone, label: "Pubs" },
  ],
  partenaire: [
